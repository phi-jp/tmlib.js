...
var UI_DATA = {
    TITLE_SCENE: {
        children: [
            ...
            {
                type:"IconButton",name:"tmlibIconButton",
                x:SCREEN_WIDTH-60,y:SCREEN_HEIGHT-60,width:80,height:80,
                fillStyle:"white",shadowColor:"#00f",shadowBlur:16,
                text:"Start",fontSize:40,align:"center",baseline:"middle"
            },
            {
                type:"IconButton",name:"blogIconButton",
                x:SCREEN_WIDTH-60-100,y:SCREEN_HEIGHT-60,width:80,height:80,
                fillStyle:"white",shadowColor:"#00f",shadowBlur:16,
                text:"Start",fontSize:40,align:"center",baseline:"middle"
            },
        ]
...
var TitleScene = tm.createClass({
    ...
    init: function(color) {
        ...
        this.addChild( tm.prim.RectSprite(SCREEN_WIDTH, SCREEN_HEIGHT, "rgba(0, 0, 0, 0.5)") );
