...
tm.preload(function() {
    ...
    tm.graphics.TextureManager.add("mapImage", "http://assets.wonderfl.net/images/related_images/e/ef/ef41/ef415c45339b10ebe3697131179e72a5c864f3cb");
...
tm.define("tests.mapsprite.DemoScene", {
    ...
    init: function() {
        ...
        this.map = tm.app.MapSprite(12, 12, mapData).addChildTo(this);
